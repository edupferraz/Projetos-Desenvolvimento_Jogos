...
public class Tile {
	...
	public static BufferedImage TILE_Dia = Game.spritesheet.getSprite(16, 16, 16, 16);
	public static BufferedImage TILE_Noite = Game.spritesheet.getSprite(32, 16, 16, 16);
	public static BufferedImage TILE_Solido = Game.spritesheet.getSprite(32, 0, 16, 16);
